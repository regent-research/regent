...
def make_atari(task_name: str, episodic_life: bool = True, clip_reward: bool = True, **kwargs) -> Env:
    kwargs = {"frameskip": 1, **kwargs} # "repeat_action_probability": 0.0
    assert "repeat_action_probability" in kwargs, f'Please provide "repeat_action_probability" in kwargs for task {task_name}.'
