...
def _interleave_map_style_datasets(
    ...
    **kwargs,
    ...
    return concatenated_datasets, indices


class TempDataset(torch.utils.data.Dataset):
    def __init__(self, concatenated_datasets, indices):
        self.concatenated_datasets = concatenated_datasets
        self.indices = indices

    def __getitem__(self, idx):
        return self.concatenated_datasets[int(self.indices[idx])]
...
def interleave_datasets(
    ...
    if dataset_type is Dataset:
        concatenated_datasets, indices = _interleave_map_style_datasets(
            datasets,
            probabilities,
            seed,
            info=info,
        ...
        return TempDataset(concatenated_datasets, indices)
    else:
