...
# If behavior cloning terminate the script early
    ...
    start = time.time()
    num_updates = 1000 # og: int(args.num_env_steps) // args.num_steps // args.num_processes
    ...
    try:
        ...
        ob_rms = None
    test_reward = evaluate(actor_critic, ob_rms, args.env_name, args.seed,
             args.num_processes, eval_log_dir, device, num_episodes=100, atari_max_steps=args.atari_max_steps)
