...
def get_args():
    ...
    if args.default_experiment_params != 'None':
        ...
        ## Atari default settings
            ...
            args.ensemble_lr = 2.5e-4
            args.ensemble_size = 5
            args.num_ensemble_train_epoch = 1001 # new: updated value since it converged early # og: 1001
            args.bc_train_epoch = 1001 # new: updated value since it converged early # og: 1001
